/*
  ...
  - Added the required column `chatTypes` to the `Message` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Message" ("content", "conversationId", "createdAt", "deletedAt", "guestId", "id", "senderType", "updatedAt", "userId") SELECT "content", "conversationId", "createdAt", "deletedAt", "guestId", "id", "senderType", "updatedAt", "userId" FROM "Message";
DROP TABLE "Message";
